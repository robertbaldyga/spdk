...
$rpc_py bdev_ocf_create PartCache wt Malloc0 NonExisting --create --force
...
$rpc_py bdev_ocf_create FullCache wt Malloc0 Malloc1 --create --force
...
$rpc_py bdev_ocf_create HotCache wt Malloc0 Malloc1 --create --force
...
$rpc_py bdev_ocf_create PartCache wt NonExisting Malloc1 --create --force
